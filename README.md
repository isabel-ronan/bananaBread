...
- 'Bread' is closer in vector space to 'banana bread' than 'cake' is to 'banana bread'. This is the right answer. 
...
- The distance between the cake to banana bread embeddings is greater than the distance from the bread to banana bread embeddings, meaning that cake is less similar to banana bread than bread. This is the right answer.